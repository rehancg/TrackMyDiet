...
import ParallexHeader from './ParallexHeader';
import Text from 'app/components/Text';
import { FontWeights, TextTypes } from 'app/types/entity/Texts';
import Header from './Header';

const PARALLEX_HEADER_HEIGHT = DEVICE_HEIGHT * 0.4
...
const Article: React.FC = () => {
    ...
    return (
        <ViewWrapper withoutScrollView isReady={true} withAnimation withSafeAreaView safeAreaBackgroundColor={theme.BACKGROUND_PRIMARY} barStyle={theme.BAR_STYLE_SECONDARY} style={styles.container}>
            ...
            >
                <Text style={styles.title} weight={FontWeights.BOLD}>Health Benefits of Exercise and Physical</Text>
                <Text style={styles.content} type={TextTypes.PARAGRAPH}>
            ...
            <ParallexHeader scrollY={scrollY} headerHeight={PARALLEX_HEADER_HEIGHT} />
            <Header scrollY={scrollY} headerHeight={PARALLEX_HEADER_HEIGHT} />
        </ViewWrapper>
    )
}
...
const styles = StyleSheet.create({
    ...
    contentContainer: {
        ...
        paddingTop: PARALLEX_HEADER_HEIGHT,
        paddingBottom: 100
    },
    title: {
